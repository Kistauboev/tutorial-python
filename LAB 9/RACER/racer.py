...
background = pygame.image.load('LAB 9/RACER/AnimatedStreet (2).png')
...
# Load sounds
background_sound = pygame.mixer.Sound("LAB 9/RACER/background.wav")
crush_sound = pygame.mixer.Sound("LAB 9/RACER/crash.wav")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load('LAB 9/RACER/Enemy (1).png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.speed = 7
        self.image = pygame.image.load('LAB 9/RACER/Player (2).png')
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        if self.random_number in [0, 1, 2]:
            self.image = pygame.image.load("LAB 9/RACER/Coin(1).png")
        else:
            self.image = pygame.image.load("LAB 9/RACER/cent.png")
